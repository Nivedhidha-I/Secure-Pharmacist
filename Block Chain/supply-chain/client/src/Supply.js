...
function Supply() {
    ...
    <div class=" p-1 d-flex justify-content-center"> <span ><b>Current Account Address:</b> {currentaccount} </span>
                <span onClick={redirect_to_home} className="btn btn-outline-secondary btn-sm ml-1"> HOME</span></div>
            <br />
            <div class="content">
        ...
        <div class="box1">
            ...
            <table className="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Current Processing Stag</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div class="containter pt-3 pb-1 px-1 m-0 ">
                <div class="bg">
            ...
            <form onSubmit={handlerSubmitRMSsupply}>
                ...
                <button className="btn btn-outline-light btn-sm m-2" onSubmit={handlerSubmitRMSsupply}>Supply</button>
            </form>
            <hr />
            <br />
            ...
            <form onSubmit={handlerSubmitManufacturing}>
                <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn btn-outline-light btn-sm m-2" onSubmit={handlerSubmitManufacturing}>Manufacture</button>
            </form>
            <hr />
            <br />
            ...
            <form onSubmit={handlerSubmitDistribute}>
                <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn btn-outline-light btn-sm m-2" onSubmit={handlerSubmitDistribute}>Distribute</button>
            </form>
            <hr />
            <br />
            ...
            <form onSubmit={handlerSubmitRetail}>
                <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn btn-outline-light btn-sm m-2" onSubmit={handlerSubmitRetail}>Retail</button>
            </form>
            <hr />
            <br />
            ...
            <form onSubmit={handlerSubmitSold}>
                <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn btn-outline-light btn-sm m-2" onSubmit={handlerSubmitSold}>Sold</button>
            </form>
        </div>
        </div>
        </div>
