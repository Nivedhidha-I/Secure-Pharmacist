...
function Track() {
    ...
    if (TrackTillSold) {
        return (
            <div className="container-xl ">
                ...
                <span onClick={() => {
                    history.push('/')
                }} className="btn btn-outline-primary btn-sm"> HOME</span>
            </div >
        )
    }
    if (TrackTillRetail) {
        ...
        return (
            <div className="container-xl">
                <article className="col-4">
                    ...
                    <span onClick={() => {
                        history.push('/')
                    }} className="btn btn-outline-secondary btn-sm"> HOME</span>
                </article>
                {/* <section className="row">
    ...
    return (
        <div>
            ...
            <div class=" pt-2 d-flex justify-content-center"> <span ><b>Current Account Address:</b> {currentaccount} </span>
                <span onClick={redirect_to_home} className="btn btn-outline-secondary btn-sm ml-1"> HOME</span></div>

            <div class="content">
                <h2>Tracking</h2>
                <div class="row p-1">
                <div class="col box1 m-1">
                ...
                <div class="col m-1 d-flex justify-content-center align-items-center flex-column">
                    <div class="box2 p-2">
                    <h4>Enter Medicine ID to Track it</h4>
                    <form onSubmit={handlerSubmit}>
                        <input className="form-control-sm mb-2" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                        <br></br>
                        <button className="btn btn-outline-light btn-sm" onSubmit={handlerSubmit}>Track</button>
                    </form></div>
                </div></div>
